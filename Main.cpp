...
int main(){
  ...
  //for print
  std::cout << "Books in Catalog:" << std::endl;
  ...
  moveAll("Murder Mystery", catalog, cart);
  moveAll("Dying Earth", catalog, cart);
  moveAll("Atmospheric Sciences", catalog, cart);

  //checking the cart after move...
  std::cout << "Books in Cart:" << std::endl;
